...
prognostic_nn_ensemble_ics: deploy_ml_experiments
	...
	./run_ICs.sh \
		...
		gs://vcm-ml-experiments/2021-05-11-nudge-to-c3072-corrected-winds/nn-ensemble-model/initial_conditions_runs_rf_rad
...
prognostic_report_ic_ensembles: deploy_ml_experiments
	cd workflows/prognostic-run-report; \
